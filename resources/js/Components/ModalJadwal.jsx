            ...
            <div className="bg-white w-full max-w-md rounded-lg shadow-lg p-6 relative">
                ...
                <div className="space-y-3 max-h-64 overflow-y-auto">
                    {data.length > 0 ? (
                        data.map((j, index) => (
                            <label
                                key={index}
                                className={`flex items-center justify-between border rounded-lg px-4 py-3 cursor-pointer transition ${selected === index
                            ...
                            >
                                <div>
                                    ...
                                    <div
                                        ...
                                        dangerouslySetInnerHTML={{ __html: j.keterangan }}
                                    />
                                </div>
                                <input
                                    type="radio"
                ...
                <div className="flex justify-end gap-2 mt-6">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 text-sm rounded-md text-white ${selected !== null
