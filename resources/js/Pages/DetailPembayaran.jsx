    ...
    return (
        <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-6 space-y-6">
                ...
                {/* Payment Status */}
                {paymentStatus && (
                    <div className={`rounded-lg p-4 border ${paymentStatus.includes('✅') ? 'bg-green-50 border-green-200 text-green-800' :
                        paymentStatus.includes('⏳') ? 'bg-yellow-50 border-yellow-200 text-yellow-800' :
                            paymentStatus.includes('❌') ? 'bg-red-50 border-red-200 text-red-800' :
                ...
                {env.app_debug && (
                    <div className="bg-gray-100 rounded-lg p-3 text-xs">
                        ...
                        <div>Snap Token: {pembayaran.snap_token ? '✓ Available' : '✗ Not Available'}</div>
                        <div>Environment: {env.midtrans_is_production ? 'Production' : 'Sandbox'}</div>
                    </div>
                )}
                ...
                <button
                    ...
                    className={`w-full font-bold py-4 px-6 rounded-lg transition-all duration-200 transform focus:outline-none focus:ring-4 ${isProcessing || !pembayaran.snap_token
                ...
                >
                    <div className="flex items-center justify-center space-x-2">
                        ...
                        <span>
                            {!pembayaran.snap_token ? 'Token Tidak Tersedia' :
